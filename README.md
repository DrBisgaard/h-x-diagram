...
<head>
    <meta charset="UTF-8">
    <title>Absolute Humidity & Relative Humidity</title>
    <script src="https://cdn.plot.ly/plotly-latest.min.js"></script>
</head>
<body style="font-family: sans-serif; padding: 20px;">

<h2>Absolute Humidity & Relative Humidity Webapp</h2>
...
<script>
    ...
    function pressureFromAltitude(h_m) {
        ...
        // Guard for very high/low values where term could be <= 0
        if (term <= 0) return 0;
    ...
    function enthalpy(T, x_g_per_kg) {
        const x = x_g_per_kg / 1000; // convert to kg/kg
    ...
    function updatePlot() {
        ...
        Plotly.newPlot('plot', [trace1, trace40, trace60, trace2, trace3, trace4, trace5], layout);
    }
